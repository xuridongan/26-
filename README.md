...
系统在 Gazebo 中构建了包含楼宇、垃圾桶、人群和道路边界等元素的 **20000 mm × 20000 mm** 仿真场地，并以移动机器人平台为载体，集成激光雷达、RealSense D435 相机和里程计等传感器，为环境感知、建图定位和目标识别提供数据基础。
